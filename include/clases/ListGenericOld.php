	...
	public function obtenerPendientesBac($estado) 
	{
        ...
        $sql = 'SELECT e.idEstudioBac 
                ...
                WHERE 
                    ...
                    u.idCatEstado = '.$estado.' AND 
                    e.fechaResultado IS NULL AND
                    e.folioLaboratorio IS NOT NULL AND 
                    [muestraRechazada]=0
                UNION
                SELECT e.idEstudioBac 
    ...
    public function getRecepMuestraBac(){
        ...
        $sql = 'SELECT [idDiagnostico]
          ...
          WHERE [folioLaboratorio] IS NULL AND 
               [idCatSolicitante] IN 
                    (SELECT [idCatUnidad] FROM [catUnidad] WHERE [idCatEstado]='.$_SESSION[EDO_USR_SESSION].')';
