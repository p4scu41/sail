...
class ReporteMAE {
	...
	public function imprimirReporte() {
		...
		'<TR ALIGN="center"><TH COLSPAN="8"> </TH><TH COLSPAN="14"> Grupos de Edad </TH><TH COLSPAN="21"'.	// COLSPAN="24"			// enf ?
		'> </TH></TR>'.
		'<TR ALIGN="center"><TH ROWSPAN="3"> Entidad Federativa </TH><TH COLSPAN="4"> Casos Nuevos '. $this->ano .' </TH><TH COLSPAN="3"> Forma de detección </TH>'.
		 ...
		 '<TH> Tasa de Prevalencia </TH><TH> % del total </TH><TH COLSPAN="2">'. // COLSPAN="3">'.			// enf ?
		 'Contactos de la prevalencia </TH><TH COLSPAN="2">'. // COLSPAN="3">'.								// enf ?
		 'Contactos Vig PTX </TH><TH COLSPAN="2">'. // COLSPAN="3">'.										// enf ?
		 'Contactos Total </TH></TR>'.
		'<TR ALIGN="center"><TH>MB</TH><TH>PB</TH><TH>S/C</TH><TH>Total</TH><TH>Consulta</TH><TH>Contacto</TH><TH>Población</TH><TH>H</TH><TH>M</TH><TH>H</TH><TH>M</TH><TH>H</TH><TH>M</TH><TH>H</TH><TH>M</TH><TH>H</TH><TH>M</TH>'.
		 ...
		 '<TH>Reg</TH><TH>Exam</TH>' . //<TH>Enf</TH>' .													// enf ?
		 '<TH>Reg</TH><TH>Exam</TH>' . //<TH>Enf</TH>' .													// enf ?
		 '<TH>Reg</TH><TH>Exam</TH>' . //<TH>Enf</TH>' .													// enf ?
		 '</TR></THEAD>';
		...
		for ($i = 1; $i < $longitud; $i++) {
			...
			echo '<TR><TD>'.$objTemp->nombre.'</TD><TD>'.$objTemp->casosNuevosMB.'</TD><TD>'.$objTemp->casosNuevosPB.'</TD><TD>'.$objTemp->casosNuevosSC.'</TD><TD>'.$objTemp->casosNuevosTotal.'</TD><TD>'.
				...
				$objTemp->contactosPrevalenciaReg.'</TD><TD>'.$objTemp->contactosPrevalenciaExam.'</TD><TD>'. //$objTemp->contactosPrevalenciaEnf.'</TD><TD>'.			// enf ?
				$objTemp->contactosVigPTXReg.'</TD><TD>'.$objTemp->contactosVigPTXExam.'</TD><TD>'. //$objTemp->contactosVigPTXEnf.'</TD><TD>'.							// enf ?
				$objTemp->contactosTotalReg.'</TD><TD>'.$objTemp->contactosTotalExam. //<TD>'. $objTemp->contactosTotalEnf.												// enf ?
				'</TD></TR>';
		}
	...
	public function imprimirMunicipiosPrioritarios() { 
