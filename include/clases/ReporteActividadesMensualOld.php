...
class ReporteActividadesMensual {
	...
	public function generarReporte() {
		if (is_null($this->idCatEstado) || is_null($this->idCatJurisdiccionLaboratorio) || is_null($this->fechaFin) || is_null($this->fechaInicio)) {
			...
			$sql = "SELECT " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . ") AS totBac, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioDia . ") AS estBacDiaPen, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioCon . ") AS estBacConPen, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NOT NULL AND bacIM IS NOT NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioDia . " ) AS estBacDiaPos, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NOT NULL AND bacIM IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioDia . " ) AS estBacDiaNeg, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NOT NULL AND bacIM IS NOT NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioCon . " ) AS estBacConPos, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosBac b WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NOT NULL AND bacIM IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioCon . " ) AS estBacConNeg, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosHis h WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . ") AS totHis, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosHis h WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioDia . ") AS estHisDiaPen, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosHis h WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NULL AND idCatTipoEstudio = " . self::$idCatTipoEstudioCon . ") AS estHisConPen, " .
			"(SELECT COUNT(idDiagnostico) FROM estudiosHis h WHERE fechaSolicitud BETWEEN '" . $fIni . "' AND '" . $fFin . "' AND idCatEstadoLaboratorio = " . $this->idCatEstado . " AND idCatJurisdiccionLaboratorio = " . $this->idCatJurisdiccionLaboratorio . " AND fechaResultado IS NOT NULL AND idCatHisto = " . self::$idCatHistoLL . " AND idCatTipoEstudio = " . self::$idCatTipoEstudioDia . " ) AS esthisDiaLL, " .
			...
			if (is_string($consulta)) {
				...
				if ($this->idCatJurisdiccionLaboratorio == 0) {
					...
					"AND u.idCatEstado = " . $_SESSION[EDO_USR_SESSION] . " " .
	...
	public function obtenerBD($idPaciente, $fIni, $fFin, $idCatTipoEstudioDia, $idCatEstado, $idCatJurisdiccionLaboratorio) {
		...
		if (is_string($consulta)) {
			...
			$sql = "SELECT TOP 1 h.idCatHisto, ch.descripcion FROM estudiosHis h, catHistopatologia ch, diagnostico d WHERE h.idCatHisto = ch.idCatHisto " .
				"AND d.idPaciente = " . $idPaciente . " AND h.idCatTipoEstudio = " . $idCatTipoEstudioDia . " ORDER BY h.fechaSolicitud desc;";
			$consulta = ejecutaQueryClases($sql);
			//echo $sql.'<br><br>';
			if (is_string($consulta)) {
				$this->error = true;
