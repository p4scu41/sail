...
<script type="text/javascript" src="js/cedulaPaciente.js"></script>
...
<?PHP
    ...
    $objHTML->startForm('capturaPaciente', '?mod=cap&id='.$_GET['id'], 'POST', array("enctype" => "multipart/form-data"));
        ...
        $objHTML->startFieldset('');
			$objHTML->inputText('Nombre del médico que elaboró la cédula', 'medicoElaboro', $paciente->medicoElaboro, array('size'=>'30', 'maxlength'=>'20', 'class'=>'validate[required]'));
			echo '<br />';
            $objHTML->inputText('Nombre del coordinador que supervisó/validó la cédula', 'medicoValido', $paciente->medicoValido, array('size'=>'30', 'maxlength'=>'20', 'class'=>'validate[required]'));
		$objHTML->endFieldset();
