...
$objHTML->startFieldset('Control de calidad de la muestra');
    ...
    echo '<br>(En caso de ser Inadecuada especcifique las razones)<div id="div_calidadMuestra" class="calidadInadecuada">';
    ...
    echo '<br>(En caso de ser Inadecuada especcifique las razones)<div id="div_calidadFrotis" class="calidadInadecuada">';
    ...
    echo '<br>(En caso de ser Inadecuada especcifique las razones)<div id="div_calidadTincion" class="calidadInadecuada">';
    ...
    echo '<br>(En caso de ser No concordante especcifique las razones)<div id="div_calidadLectura" class="calidadInadecuada">';
    ...
    echo '<br>(En caso de ser Inadecuada especcifique las razones)<div id="div_calidadResultado" class="calidadInadecuada">';
